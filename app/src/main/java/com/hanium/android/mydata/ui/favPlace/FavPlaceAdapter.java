...
import com.hanium.android.mydata.ui.favBrand.FavBrandAdapter;

public class FavPlaceAdapter extends CursorAdapter {

    LayoutInflater inflater;
    int layout;

    public FavPlaceAdapter(Context context, int layout, Cursor c) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        FavPlaceAdapter.ViewHolder holder = new FavPlaceAdapter.ViewHolder();
        view.setTag(holder);
        return view;
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        FavPlaceAdapter.ViewHolder holder = (FavPlaceAdapter.ViewHolder) view.getTag();
